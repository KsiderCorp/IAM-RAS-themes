...
wp_enqueue_style( 'social', get_template_directory_uri() . '/fw/social-likes/likely.css', '', 'all' );
wp_enqueue_script( 'socialjs', get_stylesheet_directory_uri() . '/fw/social-likes/likely.js',false, null, true );
	
wp_enqueue_script( 'bxslider', get_template_directory_uri() . '/fw/fotorama/fotorama.js', false, null, true);
wp_enqueue_style( 'bxstyle', get_template_directory_uri() . '/fw/fotorama/fotorama.css', '', 'all' );
...
// Icon
wp_enqueue_style( 'icon', get_template_directory_uri() . '/fw/icons/styles.css', '', 'all' );
