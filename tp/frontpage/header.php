<div class="front-page_header" id="header">
    <div class="block">
        <div class="front-page_main">
...
<i class="icon-location"></i>125040, Россия, Москва, 
...
<i class="icon-phone"></i> +7 495 946-18-06, <a href="mailto:iam@iam.ras.ru"><i class="icon-mail"></i> iam@iam.ras.ru</a>
           </div> 
                  
  <div class="header-ras_sideprojects">
...
<div class="scrolldown spied frontpage" id="getFixed">
    <ul class="nav">
        ...
        <li>
        <a href="#reward" class="scrollto">Достижения</a></li>
